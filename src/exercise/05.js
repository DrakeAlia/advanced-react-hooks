...
// Then, you can accept a ref as the second argument.
function MessagesDisplay({messages}, ref) {
  ...
  // You useImperativeHandle on that ref
  // You provide a function that returns all of the properties that you want to be assigned to that ref.
  // You provide a function that returns the value you want to be assigned to the current property.
...
// the first thing you do is forward ref.
